// Advanced numeric operations demonstrating strongly typed compilation
// This example only uses numbers and booleans to test current implementation
...
// Final complex expression combining multiple operations
let finalScore =
	(price * quantity + cost * 2) / (discount + tax + 1) - negativePrice;
